# bouncing_balls_2_bv.py  14Aug2024  crs, from bouncing_balls_2.py
"""
Blind Version - Using turtle_braille.py
...
import time
import turtle
import wx_turtle_braille as tb
...
while running:
    ...
    screen_update()
    tb.mainloop()       # Give static picture
