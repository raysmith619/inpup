# square_lattice_bv.py  16aUG2024  crs, from square_lattice.py
#                       20Feb2022  crs, Author
""" With changes for blind viewer
"""
...
if __name__ == "__main__":
    nsquare = 4     # number of squares wide
    nfig = 200
    nfig = 3  # Smaller number
    colors = ["red", "orange", "yellow",
          "green", "blue", "indigo", "violet",
          "gray", "black", "pink"]

    lt = SquareLattice(nsquare=nsquare)
    for i in range(nfig):
