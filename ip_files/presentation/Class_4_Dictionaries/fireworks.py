# fireworks.py  04Nov2025  crs, Drop import *
#               19Feb2022  crs, Author
"""
...
"""
import turtle as tu     # See graphics functions as tu.xxx
...
def fireworks_update():
    ...
    for fw in firework_list:
        firework_display(fw)
    tu.ontimer(fireworks_update, int(update_time*1000))  # reprime
    
    
def fireworks_start():
    """ Create all fireworks
    Startup fireworks
    """
    global running
...
tu.mainloop()      # Do event processing
