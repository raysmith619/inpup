...
ybb = yb + light_size
# Add lights
r = canvas.create_oval(x_min,yt,x_max,ytb)
y = canvas.create_oval(x_min,ym,x_max,ymb)
g = canvas.create_oval(x_min,yb, x_max,ybb)
...
def green_light():
    ...
    canvas.after(time_green, yellow_light)
