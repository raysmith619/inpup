...
Introduce variable number of function arguments,
using the parameter name "*args"
With the "*" python knows that the function
definer (You)wants to consider the list of
comma-separated parameters as a list.
Please see function definition "add_friends" below
"""
